                ...
                <div class="row">
                    <div class="col-3">
                        <div class="nav flex-column nav-pills adminNav" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Profiles</a>
                    ...
                    <div class="col-9">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab"><?php include 'usersList.php' ?></div>
...
-->
    ...
    <script src="includes/getUsers.js"></script>
</body>
